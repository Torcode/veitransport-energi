...
[![pr-kontroller](https://github.com/Torcode/veitransport-energi/actions/workflows/pr-checks.yml/badge.svg)](https://github.com/Torcode/veitransport-energi/actions/workflows/pr-checks.yml) — lint og 120 tester uten nettverk, mot committede uttrekk, samt en kontroll av at R-laget leser de samme tallene som Python. Nettverkskrevende kildekontroller inngår ikke og kjøres manuelt.
...
**Status: fase 3 av 7 gjennomført** (fase 4 utgår; prognosemodul er avvist med begrunnelse). Datalaget, den historiske statistikken og modellkjernen med validering ligger her. Scenarioer, beslutningsflate og rådgivernotat gjenstår. Sist oppdatert etter beslutning D-0030.
...
| [tests/](tests/) | 120 tester, alle demonstrert å kunne feile før de ble beholdt |
...
pytest                                       # 120 tester, uten nettverk
