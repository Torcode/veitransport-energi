...
Primærkilden er lest: SSB Notater 2018/45, vedlegg A (s. 51–52) — tetthet (A2) og netto energiinnhold/NCV (A3). Verdier: bensin 0,74 kg/l og 43,9 GJ/tonn (avledet 32,486 MJ/l); diesel ekskl. bioandel 0,84 og 43,1 (36,204 MJ/l); biodiesel 0,88 og 36,8; bioetanol 0,791 og 26,8. Kilden presiserer at verdiene er gjennomsnitt. Faktorene er implementert i `energy.py` med tester som låser dem til kildens tall; avledninger regnes i kode, aldri for hånd. Fase 0-magnitudesjekken er samtidig forklart: implisitt 32,2–32,6 MJ/l for autodiesel svarer til fossilfaktoren × 0,89–0,90, konsistent med iblandet bio; bensinavviket består som ikke-vei-allokering (fortsatt åpen, issue #2-tilgrensende). Regel videre: energitall merkes NCV, og bioandelen håndteres eksplisitt — fossilfaktor bare på fossilandel. Konsekvens: D-0011-sperren løftes når denne PR-en merges; energiomregning av totalvolum venter på årlige miksandeler (unit_map: delvis_verifisert). **Opphav: foreslått av KI-assistenten. Status: foreslått — formell løfting skjer ved prosjekteiers merge.**
